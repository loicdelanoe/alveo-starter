...
<template>
    <div class="gap-2 flex flex-col items-start">
        <!-- <div v-if="imagePreviews" class="gap-4 flex w-full flex-wrap">
            <img v-for="image in imagePreviews" :key="image" :src="image" alt="Preview" class="w-62 rounded-lg aspect-square object-cover" />
        </div> -->

        <MediaDropdown class="h-90 w-full" />
